...
plt.savefig('plots/healpix_generated_random_test.png', transparent=True)
plt.savefig('plots/healpix_generated_random_test.pdf', transparent=True)
plt.savefig('plots/healpix_generated_random_test.eps', transparent=True)
plt.clf()
...
_path      = '/path/to/healpix_fit_maps/'
...
#file2      = 'cmass-dr12v4-S-Reid-full.dat.fits'
#file2      = 'Y1LSSmask_v2_redlimcut_il22_seeil4.0_4096ring.fits'
...
_path_clumpy = '/path/to/CLUMPY/output/'
...
exposure_hpx = Map.read('/path/to/healpix_fit_maps/exposure_healpix_full_clean_gt20MeV.fits')
...
#plt.savefig('plots/healpix_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM100GeV_gal2D_LOS0_90_FOVdiameter360.png', transparent=True)
#plt.savefig('plots/healpix_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM100GeV_gal2D_LOS0_90_FOVdiameter360.pdf', transparent=True)
#plt.savefig('plots/healpix_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM100GeV_gal2D_LOS0_90_FOVdiameter360.eps', transparent=True)
#plt.savefig('plots/healpix_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM500GeV_axial_gal2D_LOS0_90_FOVdiameter360.png', transparent=True)
#plt.savefig('plots/healpix_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM500GeV_axial_gal2D_LOS0_90_FOVdiameter360.pdf', transparent=True)
#plt.savefig('plots/healpix_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM500GeV_axial_gal2D_LOS0_90_FOVdiameter360.eps', transparent=True)
plt.savefig('plots/healpix_seed3120_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM100GeV_axial_gal2D_LOS0_90_FOVdiameter360.png', transparent=True)
plt.savefig('plots/healpix_seed3120_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM100GeV_axial_gal2D_LOS0_90_FOVdiameter360.pdf', transparent=True)
plt.savefig('plots/healpix_seed3120_minSubClumpM_m07_maxSubClumpM_01_minNClumps10_mDM100GeV_axial_gal2D_LOS0_90_FOVdiameter360.eps', transparent=True)
...
#skymap.scatter(vecs, c=log10e, opath='plots/healpix_NS_map_with_astrotools.pdf')
...
plt.savefig('plots/healpix_NS_map_with_astrotools.png')#, transparent=True)
plt.savefig('plots/healpix_NS_map_with_astrotools.pdf')#, transparent=True)
plt.savefig('plots/healpix_NS_map_with_astrotools.eps')#, transparent=True)
plt.clf()
"""
...
file_name= '/mnt/CLUMPY/root_ntuples/ntuple_annihil_seed1332_maxNSubclumps200_minSubClumpM_m07_maxSubClumpM01_mDM100GeV_gal2D_LOS180_0_FOVdiameter360.0deg_nside2048.root'
...
#plt.savefig('plots/healpix_seed1332_DMclumps1e3_mask_smeared1deg.png', transparent=True)
#plt.savefig('plots/healpix_seed1332_DMclumps1e3_mask_smeared1deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed1332_DMclumps1e3_mask_smeared1deg.eps', transparent=True)
plt.savefig('plots/healpix_seed1332_DMclumps1e7_mask_smeared5deg.png', transparent=True)
plt.savefig('plots/healpix_seed1332_DMclumps1e7_mask_smeared5deg.pdf', transparent=True)
plt.savefig('plots/healpix_seed1332_DMclumps1e7_mask_smeared5deg.eps', transparent=True)

#plt.savefig('plots/healpix_seed4444_DMclumps_mask_smeared5deg.png', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps_mask_smeared5deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps_mask_smeared5deg.eps', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps1e3_mask_smeared5deg.png', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps1e3_mask_smeared5deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps1e3_mask_smeared5deg.eps', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps1e7_mask_smeared5deg.png', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps1e7_mask_smeared5deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed4444_DMclumps1e7_mask_smeared5deg.eps', transparent=True)

#plt.savefig('plots/healpix_seed9111_DMclumps1e3_mask_smeared5deg.png', transparent=True)
#plt.savefig('plots/healpix_seed9111_DMclumps1e3_mask_smeared5deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed9111_DMclumps1e3_mask_smeared5deg.eps', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e4_mask_smeared5deg.png', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e4_mask_smeared5deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e4_mask_smeared5deg.eps', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e5_mask_smeared5deg.png', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e5_mask_smeared5deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e5_mask_smeared5deg.eps', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e7_mask_smeared5deg.png', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e7_mask_smeared5deg.pdf', transparent=True)
#plt.savefig('plots/healpix_seed3120_DMclumps1e7_mask_smeared5deg.eps', transparent=True)
plt.clf()
...
plt.savefig('plots/healpix_100GeV_DMclumps_map_Mdelta_GalFrame_Gauss2deg_v1.png', transparent=True)
plt.savefig('plots/healpix_100GeV_DMclumps_map_Mdelta_GalFrame_Gauss2deg_v1.pdf', transparent=True)
plt.savefig('plots/healpix_100GeV_DMclumps_map_Mdelta_GalFrame_Gauss2deg_v1.eps', transparent=True)
plt.clf()
...
t.writeto('plots/CLUMPY_test_table1.fits', overwrite=True)


"""
_path_clumpy = '/home/blessed/Documents/_Papers_ToSubmit/_DMStarsClose2GC_Minihalo/python_code/plots/'
...
hp.graticule(dpar=15, dmer=20, linestyle=':', color='black')#, local=False)
plt.savefig('plots/healpix_100GeV_DMclumps_map_Mdelta_GalFrame_Gauss2deg_v1_.png', transparent=True)
plt.savefig('plots/healpix_100GeV_DMclumps_map_Mdelta_GalFrame_Gauss2deg_v1_.pdf', transparent=True)
plt.savefig('plots/healpix_100GeV_DMclumps_map_Mdelta_GalFrame_Gauss2deg_v1_.eps', transparent=True)
plt.clf()
"""
